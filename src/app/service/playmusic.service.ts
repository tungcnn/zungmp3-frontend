...
export class PlaymusicService {
  ...
  playsong(song: Song) {
    ...
    $(function() {
      ...
      if ($('.audio-player').length) {
        var myPlayListOtion = '<ul class="more_option"><li><a href="#">' +
          '<span class="opt_icon" title="Add To Favourites">' +
          '<span class="icon icon_fav"></span></span></a></li>' +
          '<li><a href="#"><span class="opt_icon" title="Add To Queue">' +
          ...
          '<span class="icon icon_playlst"></span></span></a></li>' +
          '<li><a href="#"><span class="opt_icon" title="Share">' +
          ...
          $.each(playlist, function(index, obj) {
            if (index == current) {
              $('.jp-now-playing').html('<div class=\'jp-track-name\'>' +
                ...
                '</span><div class=\'que_data\'>' + obj.title + ' ' +
                '<div class=\'jp-artist-name\'>' + obj.artist + '</div></div></div>');
            }
          });
  ...
  playPlayList(songs: Song[], ...idPlayList: number[]) {
    ...
    $(function() {
      ...
      if ($('.audio-player').length) {
        var myPlayListOtion = '<ul class="more_option"><li><a href="#">' +
          '<span class="opt_icon" title="Add To Favourites"><span class="icon icon_fav">' +
          '</span></span></a></li><li><a href="#"><span class="opt_icon" title="Add To Queue">' +
          ...
          '<span class="icon icon_playlst"></span></span></a></li><li><a href="#">' +
          '<span class="opt_icon" title="Share"><span class="icon icon_share"></span></span></a></li></ul>';
        ...
        $('#jquery_jplayer_1').on($.jPlayer.event.ready + ' ' + $.jPlayer.event.play, function(event) {
          ...
          $.each(playlist, function(index, obj) {
            if (index == current) {
              $('.jp-now-playing').html('<div class=\'jp-track-name\'>' +
                '<span class=\'que_img\'><img src=\'' + obj.image + '\'></span>' +
                '<div class=\'que_data\'>' + obj.title + ' <div class=\'jp-artist-name\'>' + obj.artist + '</div></div></div>');
            }
          });
          $('.knob-wrapper').mousedown(function() {
            $(window).mousemove(function(e) {
